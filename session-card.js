...
function getSessionCard(
  ...
  const sessionCard = React.createElement(
    'div',
    { className: 'session-info' },
    React.createElement('h1', { className: 'topic-name' }, topicName),
    React.createElement(
      'div',
      {},
      React.createElement(
    ...
    React.createElement('h3', { className: 'speaker-info' }, speakerInfo),
    React.createElement(
      'ul',
      {},
      topics.forEach(topicBullet => {
        console.log(topicBullet);
        debugger;
        React.createElement('li', {}, topicBullet)
        return 0;
    })
      // React.createElement('li', {}, 'What is EmberJS'),
      // React.createElement('li', {}, 'Templates and Components')
    )
  );
...
function linkedinLink(userName) {
...
const rootElement = React.createElement(
  ...
  getSessionCard(
    ...
    'Akanksha Dharkar',
    'Works at being awesome',
    'akankshadharkar',
    ['What is EmberJS','Templates and Components']
  )
);

ReactDOM.render(rootElement, document.getElementById('session-cards'));
